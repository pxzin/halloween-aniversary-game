...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [BootScene, IntroScene, MainMenuScene, FachadaScene, StairsScene, BalconyScene, HallwayScene, BackyardScene, LivingRoomScene, KitchenScene, BathroomScene, BedroomScene, OfficeScene, WorldScene]
};
